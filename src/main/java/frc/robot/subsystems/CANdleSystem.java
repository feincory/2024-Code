...
public class CANdleSystem extends SubsystemBase {
  ...
  public CANdleSystem(CommandXboxController m_operatorController) {
      this.joystick = m_operatorController;
  ...
  public void periodic() {
      ...
      if(m_toAnimate == null) {
          if(!m_setAnim) {
              ...
              m_candle.setLEDs(255, 255, 255, 0, 0, 2);
              m_candle.setLEDs(255, 255, 0, 0, 2, 2);
              m_candle.setLEDs(255, 0, 255, 0, 4, 2);
              m_candle.setLEDs(0, 255, 0, 0, 6, 2);
