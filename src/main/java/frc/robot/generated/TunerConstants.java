...
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    public static final double kSpeedAt12VoltsMps = 5.8;//was 5.96
    ...
    private static final double kWheelRadiusInches = 1.74;//2024-04-04 1.65 before wheel swap, 1.76 is exact match at end of kentwood
